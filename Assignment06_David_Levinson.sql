...
-- 2024-11-17,David Levinson,Updated File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_David_Levinson')
	 Begin 
	  Alter Database [Assignment06DB_David_Levinson] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_David_Levinson;
	 End
	Create Database Assignment06DB_David_Levinson;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_David_Levinson;
...
AS
SELECT TOP 10000 M.EmployeeFirstName + ' ' + M.EmployeeLastName as ManagerName, E.EmployeeFirstName + ' ' + E.EmployeeLastName as EmployeeName
...
AS
SELECT TOP 10000 C.CategoryID, C.CategoryName, P.ProductID, P.ProductName, P.UnitPrice,I.InventoryID, I.InventoryDate, I.[Count], E.EmployeeFirstName + ' ' + E.EmployeeLastName as EmployeeName, M.EmployeeFirstName + ' ' + M.EmployeeLastName as ManagerName
FROM vCategories as C
JOIN vProducts as P on C.CategoryID = P.CategoryID
JOIN vInventories as I on P.ProductID = I.ProductID
JOIN vEmployees as E on I.EmployeeID = E.EmployeeID
